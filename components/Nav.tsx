...
export default async function Nav() {
  ...
  return (
    <>
      ...
      <nav className="w-[100vw] lg:w-full absolute lg:left-0 -left-[100vw] lg:top-0 smDesktop:pl-24 smDesktop:pr-24 lgMax:backdrop-blur-xl z-20 lgMax:peer-[:checked]:left-0">
